                                                              ...
                                                              Padding(
                                                                  ...
                                                                  child: Text(
                                                                      "lbl_welcome"
                                                                          .tr,
                                                                      style: TextStyle(
                                                                          color: appTheme.blueGray90001.withOpacity(
                                                                              0.8),
                                                                          fontSize: 16
                                                                              .fSize,
                                                                          fontFamily:
                                                              ...
                                                              Padding(
                                                                  ...
                                                                  child: Row(
                                                                      children: [
                                                                        Padding(
                                                                            padding:
                                                                                EdgeInsets.only(top: 9.v, bottom: 4.v),
                                                                        ...
                                                                        Padding(
                                                                            ...
                                                                            child: Text("lbl_live_session".tr, style: TextStyle(color: appTheme.red900, fontSize: 32.fSize, fontFamily: 'Nunito Sans', fontWeight: FontWeight.w700)))
                                                                      ])),
                                                              SizedBox(
                                                                  height:
                                                                      348.v),
                                                              Text("msg_here_you_will_be3".tr,
                                                                  style: TextStyle(
                                                                      color: appTheme
                                                                          .blueGray90001
                                                                          .withOpacity(
